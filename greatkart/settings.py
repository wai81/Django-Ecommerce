...
SECRET_KEY = 'django-insecure-)xayx-e_s^=lsr6dbhljfhpuaav^0_gwrtrcn))khyz^g6n752'
...
# астройка что мы используем собственную модель учета пользователей
...
EMAIL_HOST_USER = 'user@gmail.com' #config('EMAIL_HOST_USER')
EMAIL_HOST_PASSWORD = '123456' #config('EMAIL_HOST_PASSWORD')
